...
public class SubOI extends Component {
  ...
  /************************************************************************
     ...
     * */
  InputPort inport, nameport, extinport;

  OutputPort outport, extoutport;
  ...
  protected void execute()/* throws Throwable*/{
    ...
    Component oldReceiver = extinport.getReceiver();
    extinport.setReceiver(this);
    ...
    extinport.setReceiver(oldReceiver);
    extinport = null;
